                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="nest_id" class="form-control">
                                    ...
                                    <option value="{{ $nest->id }}" @selected(request('nest_id')==$nest->id)>
                                        {{ $nest->name }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col">
                                ...
                                <select name="searchSchoolYear" class="form-control">
                                    ...
                                    for ($year = $currentYear; $year <= 2050; $year++) { $nextYear=$year + 1;
                                        $schoolYear="$year - $nextYear" ; // Kiểm tra nếu giá trị của tùy chọn khớp với
                                        giá trị từ request $selected=$schoolYear==$selectedYear ? 'selected' : '' ;
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-sm btn-icon btn-secondary" href="{{  route('export_borrow',$user->id) }}">
