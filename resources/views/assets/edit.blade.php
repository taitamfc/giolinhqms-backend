        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="tf1">Năm sản xuât <abbr name="Trường bắt buộc">*</abbr></label> <input
                            name="year_born" type="number" value="{{ old('year_born',$item->year_born) }}"
                            class="form-control" id="" placeholder="Nhập năm sản xuất">
                        <small id="" class="form-text text-muted"></small>
                        @error('year_born')
                        <p style="color:red">{{ $message }}</p>
                        @enderror
